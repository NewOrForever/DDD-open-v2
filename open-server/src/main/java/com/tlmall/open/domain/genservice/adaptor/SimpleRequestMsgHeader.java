...
public class SimpleRequestMsgHeader {
    ...
    public void initIntime(){
        this.setInTime(LocalDateTime.now().format(DateTimeFormatter.ofPattern("YYYYMMddhhmmss")));
    }

    public void initRespTime(){
        this.setRespTime(LocalDateTime.now().format(DateTimeFormatter.ofPattern("YYYYMMddhhmmss")));
    }
}
